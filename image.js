          ...
          contents: [{
              ...
              elements: [{
                  ...
                  },
                  {
                    ...
                    type: 'select',
                    id: 'selectCheckShowHide',
                    label: 'Which show/hide on Desktop/Mobile',
                    items: [['Notuse'], ['Desktop'], ['Mobile'] ],
                    'default': 'Notuse',
                    commit: function(a, b) {
                      if ( 1 != a ) {
                        return false;
                      }
                      this.getValue() == "Notuse" && b.setAttribute("data-show-hide", "Notuse");
                      this.getValue() == "Desktop" && b.setAttribute("data-show-hide", "Desktop");
                      this.getValue() == "Mobile" && b.setAttribute("data-show-hide", "Mobile");
                    },
                    setup: function(a, b) {
                      1 == a && this.setValue(b.getAttribute("data-show-hide") || "");
                    }
                  }
              ]
          }]
